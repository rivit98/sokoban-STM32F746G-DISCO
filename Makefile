##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.29.2] date: [Tue Apr 21 18:19:21 CEST 2020]
##########################################################################################################################
...
#the following two modules are from http://schaefer.eit.h-da.de/STM32F7_SD_driver_DMA/
...
ifeq ($(USE_ETHERNET_IP), 1)
C_DEFS += -DUSE_ETHERNET_IP
endif
